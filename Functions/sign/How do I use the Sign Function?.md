The Sign Function takes in a number and returns its sign (1 if it's positive, -1 if it's negative, 0 if it's 0 or not a number). Here's how to use it in a Flo&otilde;:
