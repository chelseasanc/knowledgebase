The Random String Function takes in an integer and returns a string of random characters of that length. It's useful for generating individualized sign-up links. Here's how to use it in a Flo:
