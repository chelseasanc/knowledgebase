...
1. Find Trello in the Channels menu on the right-hand side of the designer and click it to display the list of Events.
...
####New Card Comments
Use this Event to start a Fl&otilde; when there are new comments on a card.
...
<div>
    ...
    <div style="width: 30%, float: left">
    	<img src="https://s3.amazonaws.com/azuqua_static/help-center/Channels/trello/trello-event-1.png"></img>
    </div>
</div>

####Notifications
Use this Event to start a Fl&otilde; when you receive a new notification.
...
<div>
    ...
    <div style="width: 30%, float: left">
    	<img src="https://s3.amazonaws.com/azuqua_static/help-center/Channels/trello/trello-event-2.png"></img>
    </div>
</div>
