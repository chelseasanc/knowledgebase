**Stripe not yet live, still in development and it seems a little broken?**
...
1. Set up your Fl&otilde. Actions only work after you've set up a starting Event, so make sure you've done that first. [Here's how you can start a Fl&otilde with Stripe]().
2. Find Stripe in the Channels menu on the right-hand side of the designer and click it to display the list of Actions.
